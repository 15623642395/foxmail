...
public class Mail {
	...
	public String toString() {
		return "Mail [xmlName=" + xmlName + ", sender=" + sender + ", receivers=" + receivers + ", subject=" + subject
				+ ", receiveDate=" + receiveDate + ", size=" + size + ", hasRead=" + hasRead + ", content=" + content
				+ ", ccs=" + ccs + ", files=" + files + ", from=" + from + "]";
	}
