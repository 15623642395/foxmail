...
public class MainFrame extends JFrame {
	...
	public MainFrame(MailContext ctx) {
		...
		// 邮件的信息
		this.mailInfoPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, this.filePane, this.mailScrollPane);
		this.mailInfoPane.setDividerSize(3);
		this.mailInfoPane.setDividerLocation(80);
		// 邮件列表和邮件信息的JSplitPane
		this.mailListInfoPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, this.tablePane, mailInfoPane);
		...
		// 主整个邮件界面的JSplitPane
		this.mailSplitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, this.treePane, this.mailListInfoPane);
	...
	private int showMessage(String s) {
		return JOptionPane.showConfirmDialog(this, s, "警告", JOptionPane.OK_CANCEL_OPTION);
	}
	...
	private Vector<Vector> createViewDatas(List<Mail> mails) {
		...
		for (Mail mail : mails) {
			...
			if (mail.getHasRead())
				view.add(envelopOpen);
			else
				view.add(envelopClose);
	...
	public String toString() {
		return "MainFrame [welcome=" + welcome + ", mailSplitPane=" + mailSplitPane + ", mailListInfoPane="
				+ mailListInfoPane + ", mailInfoPane=" + mailInfoPane + ", mailListTable=" + mailListTable
				+ ", tablePane=" + tablePane + ", treePane=" + treePane + ", tree=" + tree + ", mailTextArea="
				+ mailTextArea + ", mailScrollPane=" + mailScrollPane + ", filePane=" + filePane + ", fileList="
				+ fileList + ", toolBar=" + toolBar + ", inMails=" + inMails + ", outMails=" + outMails + ", sentMails="
				+ sentMails + ", draftMails=" + draftMails + ", deleteMails=" + deleteMails + ", currentMails="
				+ currentMails + ", mailFrame=" + mailFrame + ", setupFrame=" + setupFrame + ", mailLoader="
				+ mailLoader + ", systemHandler=" + systemHandler + ", systemLoader=" + systemLoader + ", mailSender="
				+ mailSender + ", currentMail=" + currentMail + ", receiveInterval=" + receiveInterval + ", in=" + in
				+ ", sent=" + sent + ", write=" + write + ", reply=" + reply + ", transmit=" + transmit + ", delete="
				+ delete + ", realDelete=" + realDelete + ", revert=" + revert + ", setup=" + setup + ", ctx=" + ctx
				+ ", envelopOpen=" + envelopOpen + ", envelopClose=" + envelopClose + ", dateFormat=" + dateFormat
				+ ", emptyListData=" + Arrays.toString(emptyListData) + "]";
	}
