...
public class SetupFrame extends JFrame {
	...
	private void confirm() {
		try {
			...
			JOptionPane.showConfirmDialog(this, e.getMessage(), "警告", JOptionPane.OK_CANCEL_OPTION);
			return;
		}
	}
	...
	private MailContext getMailContext(MailContext ctx) {
		...
		String[] values = new String[] { account, password, smtpHost, smtpPortStr, pop3Host, pop3Host, pop3PortStr };
		// 验证必填输入
